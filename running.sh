...
# Author  : Deafaroz
# (C) Copyright 2021-2022 By Deafaroz
# =========================================
...
echo -e "         OWNER : ${GREEN}Deafaroz Network ${NC}${YELLOW}(${NC} ${GREEN}Isalichall ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By Deafaroz Network ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
